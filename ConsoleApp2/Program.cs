...
public class ExampleCSharp
{
    ...
    public static int Main(string[] args)
    {
        ...
        if (args.Length < 1)
        {
            Console.Write("Choose the running mode (1 for server, 0 for client)");
        ...
        switch(arg.ToLower()) {
            ...
            case "server":
                ...
                break;
            default:
                Console.WriteLine("connectionType expects one argument 0, client, 1 or server");
                return 1;
        }

        Unicorn.PreloadUnicornAppLib();
